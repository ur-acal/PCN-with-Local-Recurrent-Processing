...
- `data/cifar100_raw.h5`, the scanGFI CIFAR-100 RAW dataset;
...
with h5py.File("data/cifar100_raw.h5", "r") as handle:
...
By default the runner reads `data/cifar100_raw.h5`, the HDF5 dataset shipped
with the 0.3.0 version of scangen.
