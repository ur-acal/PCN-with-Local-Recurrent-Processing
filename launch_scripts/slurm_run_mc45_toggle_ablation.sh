...
export ONE_OVER_Q="${ONE_OVER_Q:-1}"
...
export PATCHED_NONLINEARITY_DATA="${PATCHED_NONLINEARITY_DATA:-false}"
...
echo "scheduler_fixed_coupler_mc_index=${FIXED_COUPLER_MC_INDEX:-none}"
echo "scheduler_output_root=${OUTPUT_ROOT}"
echo "scheduler_weight_quant_factor_bits=${WEIGHT_QUANT_FACTOR_BITS}"
echo "scheduler_enob=${ENOB}"
echo "scheduler_v_dd=${V_DD}"
echo "scheduler_one_over_q=${ONE_OVER_Q}"
echo "scheduler_input_quant_bits=${INPUT_QUANT_BITS:-auto}"
echo "scheduler_center_student_input=${CENTER_STUDENT_INPUT:-auto}"
...
echo "scheduler_patched_nonlinearity_data=${PATCHED_NONLINEARITY_DATA}"
echo "scheduler_activation_curve_sharing=${ACTIVATION_CURVE_SHARING}"
echo "scheduler_enable_slow_summing_current=${ENABLE_SLOW_SUMMING_CURRENT}"
echo "scheduler_slow_summing_current=${SLOW_SUMMING_CURRENT}"
echo "scheduler_enable_slow_coupler_noise=${ENABLE_SLOW_COUPLER_NOISE}"
echo "scheduler_slow_coupler_noise=${SLOW_COUPLER_NOISE}"
