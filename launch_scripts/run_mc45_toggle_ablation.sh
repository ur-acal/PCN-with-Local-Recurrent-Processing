...
MODEL_NAME="${MODEL_NAME:-TIMMQAT5b8aNT0p25mulTIMMPCNetNoBatchNorm_PCConvReLU6_0.0eps_ToggleODEXInitFFFB_dopri5Solver_1.75TEnd_0.0001Tol_0.001WD_128BS_0.01LR_C100_3K1S96C_0.25Dropout_16Layers4l5l4_2Pool_srrlDistill_a0p3_t2p0_scanGFI_1REP}"
MODEL_DIR="${MODEL_DIR:-saved_ckpt_runs/direct_fixed}"
N_TRIALS="${N_TRIALS:-2}"
BASE_SEED="${BASE_SEED:-20260723}"
CORNER_IDS="${CORNER_IDS:-}"
OUTPUT_DIR="${OUTPUT_DIR:-results/mc45_alternative_gaussian_2trials_59p50/local}"

MC_45_CORNER_DIR="${MC_45_CORNER_DIR:-hardware_data/mc_45_corners}"
ROOM_TEMPERATURE_C="${ROOM_TEMPERATURE_C:-25.0}"
FULL_45_CORNER_C="${FULL_45_CORNER_C:-1.2e-13}"
# coupler non-linearity and variation
MC_COUPLER_NONLINEAR_VARIATION_SOURCE="${MC_COUPLER_NONLINEAR_VARIATION_SOURCE:-CU_4500_r_vs_vin.csv}" # or coupler_monte
MC_COUPLER_NONLINEAR_VARIATION_QUANTITY="${MC_COUPLER_NONLINEAR_VARIATION_QUANTITY:-resistance}" # conductance for coupler_monte
MC_COUPLER_NOMINAL_R="${MC_COUPLER_NOMINAL_R:-30e3}" # 67k for coupler_monte
...
NONLINEAR_R_CURVE_SAMPLING="${NONLINEAR_R_CURVE_SAMPLING:-multivariate_gaussian}"
