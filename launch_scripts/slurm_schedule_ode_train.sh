...
# DeepM
BLOCKS_BY_ARCH["DeepM"]="S2NoMinusZChgZNoisyI"
# 8L2p
...
ARCHES=("Large8L" "Large9L" "Large10L")
...
split_and_submit() {
  ...
  while (( i < n )); do
    ...
    ###############################################################################################
    local EXP="no_bn_${pcn}_NODE_1102_2State_scanGFI_Large2P_Models_${arch}_${img_type}_Exp"
    ###############################################################################################
