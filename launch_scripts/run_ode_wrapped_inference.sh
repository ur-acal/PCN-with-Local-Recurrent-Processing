...
# ─────────────── model list ───────────────
# Fill with models trained via run_ode_train.sh or run_ode_mixed_ft.sh
MODEL_NAMES=(
#  "PCNetNoBatchNorm_PCConvReLU6_0.0eps_ODEBlockXInit_dopri5Solver_1.5TEnd_0.0001Tol_0.0001WD_128BS_0.01LR_3K1S64C_0.0Dropout_5Layers_2Pool_scanGFI_1REP"
#  "QAT5bNT0p4mulPCNetNoBatchNorm_PCConvReLU6_0.0eps_ODEBlockXInit_dopri5Solver_1.5TEnd_0.0001Tol_0.0001WD_128BS_0.01LR_3K1S64C_0.0Dropout_5Layers_2Pool_scanGFI_2REP"
)
...
for method in "${METHOD_VALS[@]}"; do
  ...
  ##########################################################################################
  EXP_NAME="1031_scanGFI_test_${method}Method_${tol}Tol.log"
...
#######################################################
# running
# nohup bash run_ode_wrapped_inference.sh > logs/run_script_output/launcher.out 2>&1 &
