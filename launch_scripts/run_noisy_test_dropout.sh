...
MASTER_LOG="$BASE_LOGDIR/master_0626_ppcn_no_bn_noise_to_all_weight_hardtanh_nolimit_nn.log"
JOB_LOG="$BASE_LOGDIR/parallel_job_master_0626_ppcn_no_bn_noise_to_all_hardtanh_nolimit_nn.log"
